...
tech: ["PHP", "HTML", "CSS"],
description: "Developed a simple web-based identity creation and management system with form validation and a clean, responsive UI.",
...
description: "Created a system to manage room reservations, payments, and user accounts using OOP concepts and MVC-style structuring.",
github: "https://github.com/HarisAmmar117/Online-Hotel-Reservation-System",
image: "/api/placeholder/400/250"
},
{
title: "Indoor Sports Complex Management System",
tech: ["MERN", "TailwindCSS", "REST API"],
description: "Built a full-stack system for booking sports facilities and managing schedules, with REST APIs and a modern React front-end.",
...
description: "Developed a mobile app for tracking and managing daily habits with local Room database storage and interactive XML UI.",
...
image: "/api/placeholder/400/250"
  ...
  return (
    <section id="projects" className="py-20 bg-gray-50/50 dark:bg-gray-900/50 backdrop-blur-sm">
